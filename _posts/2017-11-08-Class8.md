...
PHP網站→登入/登出
(1). 安裝wamp
(2). 打開phpMyAdmin , 建立一個web2017資料庫/使用者student2017
(3). 從moodle下載web2017-sql-userdata.zip
    匯入到PhpMyAdmin
(4). 設立資料使用者student2017
(5). 把講義報告的格式copy到VSCode
vote2.php
      ↓
confirm2.php → db_func2.php
      ↓
save2.php → db_func3.php
    存檔到C:/wamp/www/
(6). 在vote2.php加入 , 檢查是否有認證
(7). 編輯login.php / db_func5.php
     Session start ( ) ;
     $_SESSION [ “ xxx ” ] = 16 ;
     $var = $_SESSION [ “ xxx “ ]
     Unset ( $_SESSION [ “ xxx “ ] )
